...
import static com.zzz.mapper.CrawlSourceDynamicSqlSupport.*;
import static org.mybatis.dynamic.sql.SqlBuilder.*;

import com.zzz.entity.CrawlSource;
...
public interface CrawlSourceMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(id, sourceName, sourceStatus, createTime, updateTime, crawlRule);
