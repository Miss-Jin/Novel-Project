...
import static com.zzz.mapper.BookCommentReplyDynamicSqlSupport.*;
import static org.mybatis.dynamic.sql.SqlBuilder.*;

import com.zzz.entity.BookCommentReply;
...
public interface BookCommentReplyMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(id, commentId, replyContent, auditStatus, createTime, createUserId);
